...
public class Sql2oCandidateRepositoryTest {
    ...
    public void whenSaveThenGetSame() {
        ...
        var candidate = sql2oCandidateRepository.save(new Candidate(0, "John Smith", "junior java dev", creationDate, true, 1, file.getId()));
    ...
    public void whenSaveSeveralThenGetAll() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var candidate1 = sql2oCandidateRepository.save(new Candidate(0, "John Smith", "junior java dev", creationDate, true, 1, file.getId()));
        var candidate2 = sql2oCandidateRepository.save(new Candidate(0, "Tom Hardy", "middle java dev", creationDate, false, 1, file.getId()));
        var candidate3 = sql2oCandidateRepository.save(new Candidate(0, "Bill Clinton", "senior java dev", creationDate, true, 1, file.getId()));
    ...
    public void whenUpdateThenGetUpdated() {
        ...
        var updatedCandidate = new Candidate(
                candidate.getId(), "Tom Hardy", "middle java dev", creationDate.plusDays(1),
    ...
    public void whenUpdateUnExistingCandidateThenGetFalse() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var candidate = new Candidate(0, "John Smith", "junior java dev", creationDate, true, 1, file.getId());
